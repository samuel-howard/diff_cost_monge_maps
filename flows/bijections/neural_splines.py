...
def searchsorted(bin_locations, inputs, eps=1e-6):
    bin_locations = bin_locations.at[..., -1].set(bin_locations[..., -1] + eps)
...
def unconstrained_RQS(
    ...
    # changed
    outputs = outputs.at[inside_interval_mask].set(outs)# outputs[inside_interval_mask] = outs
    logabsdet = logabsdet.at[inside_interval_mask].set(logdets)# logabsdet[inside_interval_mask] = logdets
